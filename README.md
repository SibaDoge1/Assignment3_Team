...
- [🗂 API Description Link](https://documenter.getpostman.com/view/18068137/UVypzH3e)
- [![Run in Postman](https://run.pstmn.io/button.svg)](https://documenter.getpostman.com/view/18068137/UVypzH3e) 을 클릭하여 웹브라우저 혹은 Postman 클라이언트에 콜렉션이 로드되면
