...
// 좋아요 추가
gameRouter.post(routes.gameDetail + routes.gameLike, 
	gameController.postGameLike);

// 좋아요 삭제
gameRouter.delete(routes.gameDetail + routes.gameLike,
...
// 게임 배포
gameRouter.post(routes.root, gameController.releaseGame);
